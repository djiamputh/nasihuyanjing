...
const settings = {
  name: "Ralzz Api's",
  description: "Ralzz Api is a simple and lightweight REST API built with Next.js, designed to provide easy access to various web functionalities.", 
  apiSettings: {
    creator: "Ralzz",
    apikey: ["rlzz00"]
  },
...
app.use((req, res, next) => {
  ...
  res.json = function (data) {
    if (data && typeof data === 'object') {
      const responseData = {
        status: data.status,
        creator: settings.apiSettings.creator || "Created Using Ralzz",
        ...data
      };
